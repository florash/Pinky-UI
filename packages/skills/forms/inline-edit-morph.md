...
`InlineEditMorph` changes a small read-only value into an editing control without a disruptive layout jump. Use it for profile names, labels, titles and compact settings.
