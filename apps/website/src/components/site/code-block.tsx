      ...
      <div className="flex items-center justify-between gap-3 border-b border-line px-4 py-2.5">
        ...
        {copy ? (
          <button
            type="button"
            onClick={onCopy}
            className="inline-flex items-center gap-1.5 rounded-pill px-2.5 py-1 font-mono text-[0.6875rem] text-ink-500 transition-colors hover:bg-blush-50 hover:text-ink-900"
          >
